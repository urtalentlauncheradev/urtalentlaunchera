      ...
      >
        <div className="bg-white border border-brand-border rounded-2xl shadow-card p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-brand-heading mb-2">Create an account</h1>
            <p className="text-brand-mute text-sm">Join U R Talent Consulting to get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-brand-mute" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-brand-mute" />
                <input
                  id="phone"
                  type="tel"
                  value={phone}
